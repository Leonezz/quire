  ...
  return (
    <AriaNumberField {...props} isInvalid={props.isInvalid ?? errorMessage !== undefined} className={composeRenderProps(className, (cls) => cx("group flex flex-col gap-1.5", cls))}>
      ...
      <Group className="flex h-9 w-fit items-center rounded-control bg-fill data-[focus-within]:bg-content data-[focus-within]:shadow-[0_0_0_1px_var(--separator),0_0_0_4px_var(--accent-soft)] group-data-[invalid]:shadow-[0_0_0_1px_var(--red)]">
        <Button slot="decrement" aria-label="Decrease" className="grid h-full w-8 cursor-default place-items-center rounded-l-control text-label-2 outline-none data-[hovered]:bg-fill data-[disabled]:opacity-40 data-[focus-visible]:ring-[3px] data-[focus-visible]:ring-accent-ring"><Icon of={Minus} size="sm" /></Button>
        ...
        <Button slot="increment" aria-label="Increase" className="grid h-full w-8 cursor-default place-items-center rounded-r-control text-label-2 outline-none data-[hovered]:bg-fill data-[disabled]:opacity-40 data-[focus-visible]:ring-[3px] data-[focus-visible]:ring-accent-ring"><Icon of={Plus} size="sm" /></Button>
      </Group>
