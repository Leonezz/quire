# Rendering evaluation — 2026-09-17

64/64 pass (100%), gate 85%. Reviewed goldens: 64.
...
| ✅ acx-sleeper | substack | Substack | extractor.semantic-boundary.v1 | 2322 | reviewed | 120 lossy conversions | - |
| ✅ anthropic-mapping | next | Next.js (inferred) | extractor.semantic-boundary.v1 | 1743 | reviewed | no date; no byline; 5 lossy conversions | - |
...
| ✅ codinghorror-nocode | ghost | Ghost 6.64 | extractor.semantic-boundary.v1 | 729 | reviewed | 5 lossy conversions | - |
...
| ✅ fasterthanlime-golang | custom | - | extractor.semantic-boundary.v1 | 4833 | reviewed | 1958 lossy conversions | - |
...
| ✅ hamel-evals | quarto | quarto-1.9.38 | extractor.semantic-boundary.v1 | 3459 | reviewed | 37 lossy conversions | - |
| ✅ harvard-annotated-transformer | jupyter | pandoc | extractor.semantic-boundary.v1 | 2732 | reviewed | no date; no byline; 12 lossy conversions | - |
| ✅ hf-rlhf | custom | - | extractor.semantic-boundary.v1 | 2685 | reviewed | 17 lossy conversions | - |
| ✅ hillelwayne-engineers | hugo | Hugo 0.37.1 | extractor.semantic-boundary.v1 | 4045 | reviewed | no byline; 1 lossy conversions | - |
...
| ✅ interconnects-o1 | substack | Substack | extractor.semantic-boundary.v1 | 1986 | reviewed | 157 lossy conversions | - |
...
| ✅ kentcdodds-context | remix | - | extractor.semantic-boundary.v1 | 1300 | reviewed | no date; no byline; 5 lossy conversions | - |
...
| ✅ lilian-agent | hugo | - | extractor.semantic-boundary.v1 | 4834 | reviewed | 8 lossy conversions | - |
| ✅ lilian-attention | hugo | - | extractor.semantic-boundary.v1 | 3541 | reviewed | 6 lossy conversions | - |
...
| ✅ ruanyifeng-curl | movabletype | Movable Type  5.2.2 | extractor.semantic-boundary.v1 | 1582 | reviewed | 4 lossy conversions | - |
| ✅ ruanyifeng-weekly | movabletype | Movable Type  5.2.2 | extractor.semantic-boundary.v1 | 4787 | reviewed | 4 lossy conversions | - |
| ✅ ruder-optim | ghost | Ghost 6.64 | extractor.semantic-boundary.v1 | 6170 | reviewed | 4 lossy conversions | - |
| ✅ rustblog-1.0 | custom | - | extractor.semantic-boundary.v1 | 1095 | reviewed | 1 lossy conversions | - |
| ✅ samaltman-ia | custom | Next.js (inferred) | extractor.semantic-boundary.v1 | 1109 | reviewed | no date; no byline; 2 lossy conversions | - |
